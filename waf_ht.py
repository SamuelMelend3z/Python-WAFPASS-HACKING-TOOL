...
def main():
    parser = argparse.ArgumentParser(description='WAFPASS-HACKING-TOOL.py - Analysing parameters with all payloads\' bypass methods, aiming at benchmarking security solutions like WAF. by Samuel Melendez')
